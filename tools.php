    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">Loja EBEC Challenge Lisbon 2019</a>
            </div>
                        ...
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <div class="row">
                                	...
                                	<div class="col-sm-6 center">
                                		<p><button type="button" name="start0" id="start0" onclick="initializeClock(15, 0, 'Grinder')" class="btn btn-success">Start&nbsp;</button></p>
                                	</div>
                                </div>
                                <div class="row">
                                	<div class="col-sm-6 center">
                        ...
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <div class="row">
                                	...
                                	<div class="col-sm-6 center">
                                		<p><button type="button" name="start1" id="start1" onclick="initializeClock(15, 1, 'Hammer A')" class="btn btn-success">Start&nbsp;</button></p>
                                	</div>
                                </div>
                                <div class="row">
                                	<div class="col-sm-6 center">
                        ...
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <div class="row">
                                	...
                                	<div class="col-sm-6 center">
                                		<p><button type="button" name="start2" id="start2" onclick="initializeClock(15, 2, 'Hammer B')" class="btn btn-success">Start&nbsp;</button></p>
                                	</div>
                                </div>
                                <div class="row">
                                	<div class="col-sm-6 center">
                        ...
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <div class="row">
                                	...
                                	<div class="col-sm-6 center">
                                		<p><button type="button" name="start3" id="start3" onclick="initializeClock(15, 3, 'Hammer C')" class="btn btn-success">Start&nbsp;</button></p>
                                	</div>
                                </div>
								<div class="row">
                                	<div class="col-sm-6 center">
                        ...
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <div class="row">
                                	...
                                	<div class="col-sm-6 center">
                                		<p><button type="button" name="start4" id="start4" onclick="initializeClock(15, 4, 'Hammer D')" class="btn btn-success">Start&nbsp;</button></p>
                                	</div>
                                </div>
                                <div class="row">
                                	<div class="col-sm-6 center">
                        ...
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <div class="row">
                                	...
                                	<div class="col-sm-6 center">
                                		<p><button type="button" name="start5" id="start5" onclick="initializeClock(15, 5, 'Hammer E')" class="btn btn-success">Start&nbsp;</button></p>
                                	</div>
                                </div>
                                <div class="row">
                                	<div class="col-sm-6 center">
                        ...
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <div class="row">
                                	...
                                	<div class="col-sm-6 center">
                                		<p><button type="button" name="start6" id="start6" onclick="initializeClock(15, 6, 'Hammer F')" class="btn btn-success">Start&nbsp;</button></p>
                                	</div>
                                </div>
                                <div class="row">
                                	<div class="col-sm-6 center">
                        ...
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <div class="row">
                                	...
                                	<div class="col-sm-6 center">
                                		<p><button type="button" name="start7" id="start7" onclick="initializeClock(15, 7, 'Level A')" class="btn btn-success">Start&nbsp;</button></p>
                                	</div>
                                </div>
                                <div class="row">
                                	<div class="col-sm-6 center">
							...
							<div class="thumbnail">
								...
								<div class="caption">
									...
									<div class="row">
										...
										<div class="col-sm-6 center">
											<p><button type="button" name="start8" id="start8" onclick="initializeClock(15, 8, 'Level B')" class="btn btn-success">Start&nbsp;</button></p>
										</div>
									</div>
									<div class="row">
										<div class="col-sm-6 center">
                        ...
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <div class="row">
                                	...
                                	<div class="col-sm-6 center">
                                		<p><button type="button" name="start9" id="start9" onclick="initializeClock(15, 9, 'Level C')" class="btn btn-success">Start&nbsp;</button></p>
                                	</div>
                                </div>
                                <div class="row">
                                	<div class="col-sm-6 center">
                        ...
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <div class="row">
                                	...
                                	<div class="col-sm-6 center">
                                		<p><button type="button" name="start10" id="start10" onclick="initializeClock(15, 10, 'Pliers A')" class="btn btn-success">Start&nbsp;</button></p>
                                	</div>
                                </div>
                                <div class="row">
                                	<div class="col-sm-6 center">
							...
							<div class="thumbnail">
								...
								<div class="caption">
									...
									<div class="row">
										...
										<div class="col-sm-6 center">
											<p><button type="button" name="start11" id="start11" onclick="initializeClock(15, 11, 'Pliers B')" class="btn btn-success">Start&nbsp;</button></p>
										</div>
									</div>
									<div class="row">
										<div class="col-sm-6 center">
							...
							<div class="thumbnail">
								...
								<div class="caption">
									...
									<div class="row">
										...
										<div class="col-sm-6 center">
											<p><button type="button" name="start12" id="start12" onclick="initializeClock(15, 12, 'Pliers C')" class="btn btn-success">Start&nbsp;</button></p>
										</div>
									</div>
									<div class="row">
										<div class="col-sm-6 center">
                        ...
                        <div class="thumbnail">
                            ...
                            <div class="caption">
								...
								<div class="row">
									...
									<div class="col-sm-6 center">
										<p><button type="button" name="start13" id="start13" onclick="initializeClock(15, 13, 'Pliers D')" class="btn btn-success">Start&nbsp;</button></p>
									</div>
								</div>
								<div class="row">
									<div class="col-sm-6 center">
                        ...
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <div class="row">
                                	...
                                	<div class="col-sm-6 center">
                                		<p><button type="button" name="start14" id="start14" onclick="initializeClock(15, 14, 'Pliers E')" class="btn btn-success">Start&nbsp;</button></p>
                                	</div>
                                </div>
                                <div class="row">
                                	<div class="col-sm-6 center">
							...
							<div class="thumbnail">
								...
								<div class="caption">
									...
									<div class="row">
										...
										<div class="col-sm-6 center">
											<p><button type="button" name="start15" id="start15" onclick="initializeClock(15, 15, 'Pliers F')" class="btn btn-success">Start&nbsp;</button></p>
										</div>
									</div>
									<div class="row">
										<div class="col-sm-6 center">
							...
							<div class="thumbnail">
								...
								<div class="caption">
									...
									<div class="row">
										...
										<div class="col-sm-6 center">
											<p><button type="button" name="start16" id="start16" onclick="initializeClock(15, 16, 'Metric Tape A')" class="btn btn-success">Start&nbsp;</button></p>
										</div>
									</div>
									<div class="row">
										<div class="col-sm-6 center">
											<p id="clock16" class="countdown">15:00</p>
										</div>
										<div class="col-sm-6 center">
                        ...
                        <div class="thumbnail">
                            ...
                            <div class="caption">
								...
								<div class="row">
									...
									<div class="col-sm-6 center">
										<p><button type="button" name="start17" id="start17" onclick="initializeClock(15, 17, 'Metric Tape B')" class="btn btn-success">Start&nbsp;</button></p>
									</div>
								</div>
								<div class="row">
									<div class="col-sm-6 center">
										<p id="clock17" class="countdown">15:00</p>
									</div>
									<div class="col-sm-6 center">
                        ...
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <div class="row">
                                	...
                                	<div class="col-sm-6 center">
                                		<p><button type="button" name="start18" id="start18" onclick="initializeClock(15, 18, 'Metric Tape C')" class="btn btn-success">Start&nbsp;</button></p>
                                	</div>
                                </div>
                                <div class="row">
                                	<div class="col-sm-6 center">
										<p id="clock18" class="countdown">15:00</p>
                                	</div>
                                	<div class="col-sm-6 center">
