        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
					...
					<li>
                        <a href="/EBECshop/tools2.php" target="_blank">Tools 3</a>
                    </li> 
					<li>
                        ...
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <div class="row">
                                	...
                                	<div class="col-sm-6 center">
                                		<p><button type="button" name="start0" id="start0" onclick="initializeClock(20, 0, 'Berbequim A')" class="btn btn-success">Start&nbsp;</button></p>
                                	</div>
                                </div>
                                <div class="row">
                                	<div class="col-sm-6 center">
										<p id="clock0" class="countdown">20:00</p>
                                	</div>
                                	<div class="col-sm-6 center">
                        ...
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <div class="row">
                                	...
                                	<div class="col-sm-6 center">
                                		<p><button type="button" name="start1" id="start1" onclick="initializeClock(20, 1, 'Berbequim B')" class="btn btn-success">Start&nbsp;</button></p>
                                	</div>
                                </div>
                                <div class="row">
                                	<div class="col-sm-6 center">
										<p id="clock1" class="countdown">20:00</p>
                                	</div>
                                	<div class="col-sm-6 center">
                        ...
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <div class="row">
                                	...
                                	<div class="col-sm-6 center">
                                		<p><button type="button" name="start2" id="start2" onclick="initializeClock(20, 2, 'Berbequim C')" class="btn btn-success">Start&nbsp;</button></p>
                                	</div>
                                </div>
                                <div class="row">
                                	<div class="col-sm-6 center">
										<p id="clock2" class="countdown">20:00</p>
                                	</div>
                                	<div class="col-sm-6 center">
                        ...
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <div class="row">
                                	...
                                	<div class="col-sm-6 center">
                                		<p><button type="button" name="start3" id="start3" onclick="initializeClock(20, 3, 'Berbequim B')" class="btn btn-success">Start&nbsp;</button></p>
                                	</div>
                                </div>
								<div class="row">
                                	<div class="col-sm-6 center">
										<p id="clock3" class="countdown">20:00</p>
                                	</div>
                                	<div class="col-sm-6 center">
                        ...
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <div class="row">
                                	...
                                	<div class="col-sm-6 center">
                                		<p><button type="button" name="start4" id="start4" onclick="initializeClock(15, 4, 'HSerrote Madeira A')" class="btn btn-success">Start&nbsp;</button></p>
                                	</div>
                                </div>
                                <div class="row">
                                	<div class="col-sm-6 center">
                        ...
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <div class="row">
                                	...
                                	<div class="col-sm-6 center">
                                		<p><button type="button" name="start5" id="start5" onclick="initializeClock(15, 5, 'Serrote Madeira B')" class="btn btn-success">Start&nbsp;</button></p>
                                	</div>
                                </div>
                                <div class="row">
                                	<div class="col-sm-6 center">
                        ...
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <div class="row">
                                	...
                                	<div class="col-sm-6 center">
                                		<p><button type="button" name="start6" id="start6" onclick="initializeClock(15, 6, 'Serrote Madeira C')" class="btn btn-success">Start&nbsp;</button></p>
                                	</div>
                                </div>
                                <div class="row">
                                	<div class="col-sm-6 center">
                        ...
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <div class="row">
                                	...
                                	<div class="col-sm-6 center">
                                		<p><button type="button" name="start7" id="start7" onclick="initializeClock(15, 7, 'Serrote Madeira D')" class="btn btn-success">Start&nbsp;</button></p>
                                	</div>
                                </div>
                                <div class="row">
                                	<div class="col-sm-6 center">
							...
							<div class="thumbnail">
								...
								<div class="caption">
									...
									<div class="row">
										...
										<div class="col-sm-6 center">
											<p><button type="button" name="start8" id="start8" onclick="initializeClock(15, 8, 'Serrote Madeira E')" class="btn btn-success">Start&nbsp;</button></p>
										</div>
									</div>
									<div class="row">
										<div class="col-sm-6 center">
											<p id="clock8" class="countdown">15:00</p>
										</div>
										<div class="col-sm-6 center">
                        ...
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <div class="row">
                                	...
                                	<div class="col-sm-6 center">
                                		<p><button type="button" name="start9" id="start9" onclick="initializeClock(15, 9, 'Máquina tico-tico A')" class="btn btn-success">Start&nbsp;</button></p>
                                	</div>
                                </div>
                                <div class="row">
                                	<div class="col-sm-6 center">
                        ...
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <div class="row">
                                	...
                                	<div class="col-sm-6 center">
                                		<p><button type="button" name="start10" id="start10" onclick="initializeClock(15, 10, 'Máquina Tico-tico B')" class="btn btn-success">Start&nbsp;</button></p>
                                	</div>
                                </div>
                                <div class="row">
                                	<div class="col-sm-6 center">
							...
							<div class="thumbnail">
								...
								<div class="caption">
									...
									<div class="row">
										...
										<div class="col-sm-6 center">
											<p><button type="button" name="start11" id="start11" onclick="initializeClock(15, 11, 'Chave Inglesa A')" class="btn btn-success">Start&nbsp;</button></p>
										</div>
									</div>
									<div class="row">
										<div class="col-sm-6 center">
							...
							<div class="thumbnail">
								...
								<div class="caption">
									...
									<div class="row">
										...
										<div class="col-sm-6 center">
											<p><button type="button" name="start12" id="start12" onclick="initializeClock(15, 12, 'Chave Inglesa B')" class="btn btn-success">Start&nbsp;</button></p>
										</div>
									</div>
									<div class="row">
										<div class="col-sm-6 center">
                        ...
                        <div class="thumbnail">
                            ...
                            <div class="caption">
								...
								<div class="row">
									...
									<div class="col-sm-6 center">
										<p><button type="button" name="start13" id="start13" onclick="initializeClock(15, 13, 'Chave de Fendas A')" class="btn btn-success">Start&nbsp;</button></p>
									</div>
								</div>
								<div class="row">
									<div class="col-sm-6 center">
                        ...
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <div class="row">
                                	...
                                	<div class="col-sm-6 center">
                                		<p><button type="button" name="start14" id="start14" onclick="initializeClock(15, 14, 'Chave de Fendas B')" class="btn btn-success">Start&nbsp;</button></p>
                                	</div>
                                </div>
                                <div class="row">
                                	<div class="col-sm-6 center">
							...
							<div class="thumbnail">
								...
								<div class="caption">
									...
									<div class="row">
										...
										<div class="col-sm-6 center">
											<p><button type="button" name="start15" id="start15" onclick="initializeClock(15, 15, 'Chave de Fendas C')" class="btn btn-success">Start&nbsp;</button></p>
										</div>
									</div>
									<div class="row">
										<div class="col-sm-6 center">
											<p id="clock15" class="countdown">15:00</p>
										</div>
										<div class="col-sm-6 center">
